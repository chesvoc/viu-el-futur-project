...
<html lang="es">
  <head>
    ...
    <title>viu el futur - salut</title>
  </head>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item active">
                <a class="nav-link" href="indexitems.html">Inici<span class="sr-only">(current)</span></a>
              </li>
              <!-- <li class="nav-item">
              ...
              <li class="nav-item dropright">
                ...
                <div class="dropdown-menu bg-success text-light" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#">Viatges</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#">Tecnología</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="salut.html" target="_BLANK">Salut</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#" target="_BLANK">Alimentació</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#" target="_BLANK">Educació</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#" target="_BLANK">Habitatge</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#" target="_BLANK">Obra pública</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="seguretat.html" target="_BLANK">Seguretat</a>
                    <a class="dropdown-item bg-success text-light submenuOpcions" href="#" target="_BLANK">Treball</a>
                  </div>
              </li>
            </ul>
          </div>
...
La entidad responsable de la recogida, procesamiento y utilización de tus datos personales, en el sentido establecido por la Ley de Protección de Datos Personales es la página , propiedad de – .
¿Qué son las cookies?
...
Las empresas que generan estas cookies tienen sus propias políticas de privacidad. En la actualidad, las webs de utilizan la plataforma Doubleclick (Google) para gestionar estos servicios. Para más información, acuda a
